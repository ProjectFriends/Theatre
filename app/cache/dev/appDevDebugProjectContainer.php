...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bizshare_user.registration.form.type' => 'getBizshareUser_Registration_Form_TypeService',
    ...
    /**
     * Gets the 'bizshare_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBizshareUser_Registration_Form_TypeService()
    {
        return $this->services['bizshare_user.registration.form.type'] = new \User\UserBundle\Form\Type\RegistrationFormType('User\\UserBundle\\Entity\\User');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'theatre', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Back\\OfficeBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\User\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Back\\OfficeBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('BackOfficeBundle' => 'Back\\OfficeBundle\\Entity', 'UserUserBundle' => 'User\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c018ab1c7f1cd358848bbb857880ec5c02956c646b79b0e1c42c08c449d9c71d');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'UserUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('webmaster@example.com' => 'webmaster'), 'resetting' => array('benmouadhalaya@gmail.com' => 'mouadh_2016'))));
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'bizshare_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n->setOptions(array('default_target_path' => '/', 'always_use_default_target_path' => true, 'login_path' => 'fos_user_security_login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $o->setOptions(array('failure_path' => NULL, 'login_path' => 'fos_user_security_login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $l, 'main', $n, $o, array('use_forward' => true, 'check_path' => 'fos_user_security_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '563a819f8f0a77.85396705', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, 'fos_user_security_login', true), NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Back\\OfficeBundle/Resources/views'), 'BackOffice');
        $instance->addPath(($this->targetDirs[3].'\\src\\Front\\OfficeBundle/Resources/views'), 'FrontOffice');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('de9c2ccd0ddfa8d74325316348ed2ab3142e40c2');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_MEMBER' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BackOfficeBundle' => 'Back\\OfficeBundle\\BackOfficeBundle',
                'FrontOfficeBundle' => 'Front\\OfficeBundle\\FrontOfficeBundle',
            ...
            'secret' => 'de9c2ccd0ddfa8d74325316348ed2ab3142e40c2',
            'locale' => 'en',
            ...
            'kernel.secret' => 'de9c2ccd0ddfa8d74325316348ed2ab3142e40c2',
            ...
            'fos_user.resetting.email.template' => 'UserUserBundle:Resetting:email.txt.twig',
            ...
            'fos_user.registration.form.type' => 'bizshare_user_registration',
            ...
            'fos_user.resetting.email.from_email' => array(
                'benmouadhalaya@gmail.com' => 'mouadh_2016',
            ),
