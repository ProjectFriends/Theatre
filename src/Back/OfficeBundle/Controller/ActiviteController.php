...
use Back\OfficeBundle\Entity\Activite;
use Back\OfficeBundle\Form\ActiviteType;
...
class ActiviteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BackOfficeBundle:Activite')->findAll();

        return $this->render('BackOfficeBundle:Activite:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BackOfficeBundle:Activite:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BackOfficeBundle:Activite')->find($id);
        ...
        return $this->render('BackOfficeBundle:Activite:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BackOfficeBundle:Activite:edit.html.twig', array(
            'entity'      => $entity,
